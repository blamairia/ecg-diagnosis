...
# ------------------------------------------------------------
# 7) LEAD SELECTION & INTERACTIVE PLOT
# ------------------------------------------------------------
...
# Placeholder: overlay red rectangles for abnormality time ranges (empty for now)
abnormal_ranges = []  # Example future format: [(t0, t1), ...]
...
# ------------------------------------------------------------
# 8) PREPROCESS FULL 12-LEAD SIGNAL FOR MODEL
# ------------------------------------------------------------
if nsteps >= 15000:
...
# ------------------------------------------------------------
# 9) MODEL INFERENCE → 9 PROBABILITIES
# ------------------------------------------------------------
with torch.no_grad():
...
# Display as a DataFrame if pandas ≥ 1.0; else fallback to Markdown bullets
try:
